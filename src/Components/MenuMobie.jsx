...
export const MenuMobie = ({OpenMenu, setOpenMenu}) => {
...
<button onClick={() => setOpenMenu(false)} className="absolute top-6 right-6 text-white text-3xl focus:outline-none cursor-pointer"
